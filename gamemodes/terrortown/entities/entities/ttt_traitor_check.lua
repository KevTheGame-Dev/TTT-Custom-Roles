...
function ENT:CountTraitors()
	...
	for _, ply in pairs(player.GetAll()) do
		if IsValid(ply) and (ply:IsActiveTraitor() or ply:IsActiveHypnotist() or ply:IsActiveVampire() or ply:IsActiveAssassin() or ply:IsActiveZombie() ply:IsActiveCrookedCop()) and ply:Alive() then
