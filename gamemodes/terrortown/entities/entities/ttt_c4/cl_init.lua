...
function ShowC4Disarm(bomb)
	...
	ddesc:SetWrap(true)
	if (LocalPlayer():IsTraitor() or LocalPlayer():IsHypnotist() or LocalPlayer():IsVampire() or LocalPlayer():IsAssassin() or LocalPlayer():IsCrookedCop() or LocalPlayer():IsZombie()) then
