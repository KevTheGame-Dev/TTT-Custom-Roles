...
function ENT:TraitorUse(ply)
	if not (IsValid(ply) and (ply:IsActiveTraitor() or ply:IsActiveHypnotist() or ply:IsActiveVampire() or ply:IsActiveAssassin() or ply:IsActiveCrookedCop() or ply:IsActiveZombie())) then return false end
...
local function TraitorUseCmd(ply, cmd, args)
	...
	if IsValid(ply) and (ply:IsActiveTraitor() or ply:IsActiveHypnotist() or ply:IsActiveVampire() or ply:IsActiveAssassin() or ply:IsActiveCrookedCop() or ply:IsActiveZombie()) then
