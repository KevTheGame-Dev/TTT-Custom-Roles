...
function TBHUD:PlayerIsFocused()
	return IsValid(LocalPlayer()) and (LocalPlayer():IsActiveTraitor() or LocalPlayer():IsActiveHypnotist() or LocalPlayer():IsActiveVampire() or LocalPlayer():IsActiveAssassin() or LocalPlayer():IsActiveCrookedCop() LocalPlayer():IsActiveZombie()) and IsValid(self.focus_ent)
end
