...
function ScoreEventLog(events, scores, traitors, detectives, hypnotists, mercenaries, jesters, phantoms, glitches, zombies, vampires, swappers, assassins, killers, cannibals, crookedcops)
	for k, s in pairs(scores) do
		...
		scores[k].was_cannibal = table.HasValue(cannibals, k)
		scores[k].was_crookedcop = table.HasValue(crookedcops, k)
	end
